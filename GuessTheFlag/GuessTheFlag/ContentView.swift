...
//  GuessTheFlag
//
//  Created by Miguel Rodriguez on 7/4/25.
//
...
struct ContentView: View {
    ...
    var body: some View {
        ZStack { // Outermost
            ...
            .ignoresSafeArea() // Allows us to fill the whitespace of the entire canvas
            ...
            VStack {
                ...
                VStack(spacing: 15) { // Within the ZStack
                    VStack {
